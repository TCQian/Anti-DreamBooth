...
#SBATCH --job-name=dreambooth_fsmg_worked   # Job name
...
export EXPERIMENT_NAME="FSMG_worked"
...
accelerate launch attacks/fsmg_worked.py \
...
echo "ISM: Running Evaluation for FSMG Worked"
